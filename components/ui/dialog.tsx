...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-md border-[1.5px] border-[var(--cct-milktea-600)] bg-[var(--card)] p-6 shadow-sticker",
        className
      )}
      {...props}
    >
